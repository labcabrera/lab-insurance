...
image:https://api.codacy.com/project/badge/Grade/ba62bafd29c84abd802cf753c412e41c["Codacy code quality", link="https://www.codacy.com/app/lab.cabrera/lab-insurance-cloud-config?utm_source=github.com&utm_medium=referral&utm_content=labcabrera/lab-insurance-cloud-config&utm_campaign=Badge_Grade"]

= Insurance Showcase Engine

Motor de gestión de productos de ahorro basado en una arquitectura de microservicios basada en:
