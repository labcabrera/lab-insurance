...
[options="header"]
|===
|Environment                | Port | Application                | Port 
|cloud-config               | 8888 | contract-creation-gateway  | 8081
|eureka                     | 8070 | legal-entity-gateway       | 8082
|zuul-gateway               | 8080 | asset-gateway              | 8089
