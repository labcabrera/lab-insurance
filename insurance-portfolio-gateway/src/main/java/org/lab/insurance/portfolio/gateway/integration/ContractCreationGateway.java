...
public interface ContractCreationGateway {
	...
	@Gateway(requestChannel = Channels.PortfolioInitializationRequest, replyChannel = Channels.PortfolioInitializationResponse)
	ContractPortfolioRelation process(String contractId);
