...
public class MongoTestOperations {
	...
	public void resetDataBase() {
		...
		alice.setAuditData(InsuranceAuditData.builder().created(Calendar.getInstance().getTime()).build());

		Person bob = new Person();
		bob.setIdCard(IdCard.builder().number(TestConstants.Persons.DEFAULT_RECIPIENT).build());
		bob.setName("Bob");
		bob.setFirstSurname("Doe");
		bob.setAuditData(InsuranceAuditData.builder().created(Calendar.getInstance().getTime()).build());
		...
		insuranceInc.setAuditData(InsuranceAuditData.builder().created(Calendar.getInstance().getTime()).build());
