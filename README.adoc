...
Microservices oriented application over:
...
* https://github.com/labcabrera/lab-insurance-cloud-config-server
* https://github.com/labcabrera/lab-insurance-eureka
* https://github.com/labcabrera/lab-insurance-sso
