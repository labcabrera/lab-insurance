...
public class ContractRouteBuilder extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		/**
		 * Endpoint que procesa la accion de dar de alta un contrato. En ese momento el
		 * contrato no esta activo (lo estara cuando se procese la el pago inicial).
		 */
		...
		/**
		 * Endpoint que procesa el evento de entrada en vigor de un contrato (se
		 * inicializan los servicios financieros, se programan los gastos, etc).
		 */
